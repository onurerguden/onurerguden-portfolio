...
Proje, kendi nicel değerlendirme kümesinde [[metric:ragAccuracy]] doğruluğa ulaştı. Tuzak soru testlerinde, bilgi getirme filtreleri ve sıkı sistem yönergeleriyle desteklenmeyen yanıtlar da kontrol edildi.
