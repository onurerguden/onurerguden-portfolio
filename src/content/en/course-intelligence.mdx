...
The project achieved 100% accuracy on its quantitative evaluation set, as reported in my CV. Trap-question tests also checked unsupported answers, using retrieval filtering and strict system prompting.
